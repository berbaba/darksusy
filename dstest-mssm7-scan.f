...
c 1001 format(1x,A12,3(1x,E14.8),1x,e7.1,5(1x,e14.8))
 ...
 20   call random_model(nevts,idum,iend)
...
c      and hwarning which are non-zero if the model is not good.
      ...
      write(*,*) '     unphys = ',unphys
      if (excl.eq.0.and.hwarning.eq.0.and.unphys.eq.0) then  ! Model OK
...
c     &     ' sigsd (pb) = ',sigsdp*1.0d36
      ...
      write(41,51) mass(kn(1)),' ',gaugfr,' ',ratesunu,' ',ratesumu,' ',convrate, 
     &   ' ',sigsdp*1.0d36,' ',sigsip*1.0d36
 51   format(f,a,e,a,e,a,e,a,e,a,e,a,e)
...
c      close(10)
      ...
      subroutine random_model(nevts,idum,iend)
c
...
c
      ...
      integer first,n,i,iend,idum,nevts
...
c       these varibles to DarkSUSY common blocks		 	 
	...
	write(*,*) ' '
        write(*,*) 'Model: ',idtag
        write(*,*) 'Parameters: ',amu,am2,ama,atb,amsq,atm,abm 	 
      else 
        iend = 1
      endif      
      return
